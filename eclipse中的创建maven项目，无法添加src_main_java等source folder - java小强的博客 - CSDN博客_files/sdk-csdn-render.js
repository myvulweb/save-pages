(function(window, document /*,undefined*/) {
  ...
  function render4P(item, renderParentDom, pos) {
    ...
    if (pos === "T0") {
      ...
      itemDom.innerHTML =
        ...
        item.item_read_cnt +
        '次阅读</span><span class="time col-md-4">' +
        showTime +
        "</span></div>";
    } else {
      itemDom = document.createElement("a");
  ...
  function addTPosStyle(item) {
    ...
    style.type = "text/css";
    style.innerHTML =
      ".recommend-box ._4paradigm_box.T3 a .content-box{margin-left:0} .recommend-box ._4paradigm_box.T3 a .content-box h4{vertical-align:top}.recommend-box ._4paradigm_box.p4courset3_target {padding:0}.recommend-box ._4paradigm_box._paradigm_T_ads_render {padding:0}";
    document.getElementsByTagName("HEAD")[0].appendChild(style);
  }
  /**
   * 判断是否是广告位若是则渲染百度广告
  ...
  function renderSlotbydup(renderParentDom, position) {
    ...
    } else if (position === "S3" || position === "S8" || position === "S14") {
